...
enum class love::common::Gamepad::GamepadButton : uint64_t
{
    ...
    GAMEPAD_BUTTON_LEFT_TRIGGER   = KEY_ZL,
    GAMEPAD_BUTTON_RIGHT_TRIGGER  = KEY_ZR,
    ...
    class Gamepad : public common::Gamepad
    {
      ...
      private:
        ...
        static constexpr auto buttons = BidirectionalMap<>::Create(
            ...
            "lefttrigger",   Gamepad::GamepadButton::GAMEPAD_BUTTON_LEFT_TRIGGER,
            "righttrigger",  Gamepad::GamepadButton::GAMEPAD_BUTTON_RIGHT_TRIGGER,
